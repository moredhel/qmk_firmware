 ...
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ Ctrl   │   A  │   S  │   D  │   F  │   G  │Enter │   H  │   J  │   K  │   L  │   ;  │   '  │   #  │  End │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ Shft │   Z  │   X  │   C  │   V  │   B  | Enter|   N  │   M  │   ,  │   .  │   /  │ Shft │ FN   │ PgUp │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ Fn │ -  │ -  │ Gui │ Alt │Space │ FN(2)    │Enter │ Left │  Up  │ Down │ Right│ Alt  │ Ctrl │ PgDn │
 * └──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┘
 */
  ...
  [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_LCTL , KC_A   , KC_S   , KC_D   , KC_F   , KC_G  , KC_ENT , KC_H  , KC_J   , KC_K   , KC_L   , KC_SCLN , KC_QUOT , KC_NUHS , KC_END ,
    KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B  , KC_ENT, KC_N  , KC_M   , KC_COMM, KC_DOT , KC_SLSH , KC_RSFT , KC_RSFT , KC_PGUP,
    MO(_FN), _______, _______, KC_LGUI, KC_LALT, KC_SPC, MO(_CHAR) , KC_ENT, KC_LEFT, KC_DOWN , KC_UP, KC_RIGHT, KC_RALT , KC_RCTL , KC_PGDN
  ),
 ...
 */
  ...
  [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    _______    ,  _______     , _______     , _______     , _______, _______, RGB_TOG, _______, _______, LSFT(KC_1) , LSFT(KC_2) , LSFT(KC_3), KC_ENT  , _______, _______,
    _______    , _______, _______     , _______     , _______     , _______,_______ , _______, _______, LSFT(KC_0) , KC_00      , KC_V      , _______ , _______, _______
  ),
 ...
 * │      │      │SltAll│SltRow│SltRow│ Brt+ │BL Stp│      │      │ KP 7 │ KP 8 │ KP 9 │   8  │      │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │      │ Cut  │ Copy │Paste │ Brt- │BL Brt│      │   {  │  }   │ KP 5 │ KP 6 │   7  │      │Reset │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │ Mute │ Vol- │ Vol+ │ Play │      |Ld Tog│      │   [  │  ]   │ KP 2 │ KP 3 │Enter │      │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │      │      │      │      │      │      │      │      │      │ KP 0 │KC 00 │  V   │      │      │      │
 * └──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┴──────┘
 */

  [_CHAR] = LAYOUT_ortho_5x15( /* CHARACTER */
    LALT(KC_F4), KC_F1  , KC_F2       , KC_F3       , KC_F4       , KC_F5  , BL_TOGG, KC_F6  , KC_F7  , KC_F8      , KC_F9      , KC_F10    , KC_F11  , KC_F12 , KC_NLCK,
    _______    , _______, SLC_ALL     , SLC_ROW     , SLC_WRD     , _______, BL_STEP, _______, _______, LSFT(KC_7) , LSFT(KC_8) , LSFT(KC_9), KC_8    , _______, _______,
    _______    , _______, LSFT(KC_DEL), LCTL(KC_INS), KC_GRV, _______, BL_BRTG, _______, LSFT(KC_MINUS), LSFT(KC_PLUS) , LSFT(KC_5) , LSFT(KC_6), KC_7    , _______, RESET  ,
    _______    ,  _______     , _______     , _______     , _______, _______, RGB_TOG, _______, KC_MINUS, KC_PLUS , LSFT(KC_2) , LSFT(KC_3), _______  , _______, _______,
    _______    , KC_MUTE, KC_VOLD     , KC_VOLU     , KC_MPLY     , _______,_______ , _______, _______, LSFT(KC_0) , KC_00      , KC_V      , _______ , _______, _______
  ),
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    default: //  for any other layers, or the default layer
        setFNDisplay(get_highest_layer(state));
        break;
    }
  return state;
}
